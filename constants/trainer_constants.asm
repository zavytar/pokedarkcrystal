...
KRIS EQU __trainer_class__
	...
	const RIVAL1_1_CHIKORITA	; RIVAL1_1_KOFFING
	const RIVAL1_1_CYNDAQUIL	; RIVAL1_1_GRIMER
	const RIVAL1_1_TOTODILE		; RIVAL1_2_KOFFING
	const RIVAL1_2_CHIKORITA	; RIVAL1_2_GRIMER
