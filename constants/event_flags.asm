...
; Johto story events
	const EVENT_GOT_A_POKEMON_FROM_ELM 			; EVENT_GOT_A_POKEMON_FROM_BASE
	const EVENT_GOT_CYNDAQUIL_FROM_ELM 			; EVENT_GOT_KOFFING_FROM_BASE
	const EVENT_GOT_TOTODILE_FROM_ELM  			; EVENT_GOT_GRIMER_FROM_BASE
	const EVENT_GOT_CHIKORITA_FROM_ELM 			; EVENT_GOT_MISSION_FROM_JERICHO
	const EVENT_GOT_MYSTERY_EGG_FROM_MR_POKEMON ; EVENT_ACTIVATED_SECURITY_SYSTEM
...
; Johto people
	const EVENT_RIVAL_NEW_BARK_TOWN		; EVENT_RIVAL_TEAM_ROCKET_BASE_B3F
	const EVENT_RIVAL_CHERRYGROVE_CITY	; EVENT_RIVAL_SLOWPOKE_WELL_B1F
